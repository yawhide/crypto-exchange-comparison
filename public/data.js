  ...
  var DATA = {
    ...
    mybtc: {
      ...
      withdrawMethods: [
        {
          type: "E-transfer",
          fee: (i) => Math.max(1, 0.0495 * i),
          min: 20,
          max: 5000,
        },
      ],
      tradingFee: (i) => (i <= 200 ? 2 : 0),
      realSpread: (i) => 0.0052 * i,
      withdrawFee: {},
      coins: {
        BTC: true,
      },
